...
$route['services/view/(:any)'] = 'servicecontroller/view/$1';
$route['services/(:any)'] = 'servicecontroller/getAll/$1';

$route['servicess/(:any)'] = 'servicecontroller/getAllWithJavascript/$1';
